...
public class SingularityShift : JoiCard
{
    public SingularityShift() : base(1, CardType.Skill, CardRarity.Uncommon, TargetType.Self) { }

    protected override IEnumerable<DynamicVar> CanonicalVars =>
    [
        new DynamicVar("WhiteHole", 5),
        new DynamicVar("BlockPerStack", 2)
    ];
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        var blockPerStack = (int)DynamicVars["BlockPerStack"].BaseValue;
        ...
        if (removed > 0 && whiteHole != null)
        {
            ...
            Owner.Creature.GainBlockInternal(removed * blockPerStack);
        }
    }
